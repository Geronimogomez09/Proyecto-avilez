...
$id = $_GET['id'];
$resultado = mysqli_query ($conn, "SELECT * FROM comentario WHERE id= $id");
...
<body>
    ...
    <form action="actualizar.php" method="post" class="mx-3 p-2" style="width:1000px">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="valor" class="form-control" id="valor" value="<?=$fila['valor']?>">
        </div>
        <div class="mb-3">
            <label for="coment" class="form-label">coment</label>
            <input type="text" name="coment" class="form-control" id="coment" value="<?=$fila['coment']?>">
        </div>
